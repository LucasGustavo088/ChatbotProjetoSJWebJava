        ...
        <div id="red">
            <div class="container">
                <div class="row centered">
                    ...
                    <br></br>
                    <br></br>
                    <img src="assets/images/maoV.png" width="400" height="250" alt="">
                    </div>
                </div><!-- row -->
            </div><!-- container -->
        ...
        <div id = "eq" >
            <div class="container w" style="margin-top: 100px;">
                <div class="row centered">
                        ...
                        <br></br>
                    <div class="col-lg-4">
                        <img class="img-circle" src="assets/images/pic2.jpg" width="110" height="110" alt="">
                    ...
                    <div class="col-lg-4">
                        <img class="img-circle" src="assets/images/pic3.jpg" width="110" height="110" alt="">
                    ...
                    <div class="col-lg-4">
                        <img class="img-circle" src="assets/images/pic4.jpg" width="110" height="110" alt="">
                        <h4>Lucas Gustavo</h4>
