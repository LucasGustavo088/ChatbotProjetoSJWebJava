	...
	<div class="wrapper">
		...
		<nav id="sidebar">
			...
			<ul class="list-unstyled components">
				<li><a href="#home_menu" data-toggle="collapse"
					aria-expanded="false"><span class="glyphicon glyphicon-home"></span>
						Home</a>
				...
				<li><a href="#chatbot_menu" data-toggle="collapse"
					aria-expanded="false"><span class="glyphicon glyphicon-comment"
						aria-hidden="true"></span> Chatbot</a>
					<ul class="collapse list-unstyled" id="chatbot_menu">
						<li class="nav-item"><a
							href="/ChatbotProjetoSJWebJava/chatbot/listar_topicos"><i
								class="fas fa-sitemap"></i> Perguntas e respostas</a></li>
